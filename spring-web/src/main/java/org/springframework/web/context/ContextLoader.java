...
public class ContextLoader {
	...
	public WebApplicationContext initWebApplicationContext(ServletContext servletContext) {
		// 判断 ServletContext 中是否已经有根上下文存在
		...
		try {
			...
			if (this.context == null) {
				/**
				 * 这里创建在 ServletContext 中存储的根上下文 ROOT_WEB_APPLICATION_CONTEXT,
				 * 同时把它存到 ServletContext 中去，注意这里使用的 ServletContext 的属性值是
				 * ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE，以后的应用都是根据这个属性值取得
				 * 上下文的
				 */
